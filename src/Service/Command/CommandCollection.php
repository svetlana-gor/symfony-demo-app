...
class CommandCollection
{
     ...
     */
    public function __construct(#[TaggedLocator('app.command_chain')] ContainerInterface $commands)
    {
        $this->commandCollection = $commands;
    }

    /**
     * @return ContainerInterface Service locator with all services tagged with a specific tag.
     */
