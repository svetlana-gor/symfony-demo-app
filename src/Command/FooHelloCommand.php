...
class FooHelloCommand extends Command
{
    ...
    /**
     * @param iterable        $commands All the services tagged with a specific tag.
     * @param LoggerInterface $logger   The current logger instance.
     */
    public function __construct(#[TaggedIterator('app.command_chain')] iterable $commands, LoggerInterface $logger)
    {
        parent::__construct();
