 ...
 */
final class Version20220120132009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE symfony_demo_product (id UUID NOT NULL, product_image_id UUID NOT NULL, title VARCHAR(100) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_1493D942F6154FFA ON symfony_demo_product (product_image_id)');
        $this->addSql('COMMENT ON COLUMN symfony_demo_product.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN symfony_demo_product.product_image_id IS \'(DC2Type:uuid)\'');
        $this->addSql('CREATE TABLE symfony_demo_product_image (id UUID NOT NULL, title VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN symfony_demo_product_image.id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE symfony_demo_product ADD CONSTRAINT FK_1493D942F6154FFA FOREIGN KEY (product_image_id) REFERENCES symfony_demo_product_image (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE symfony_demo_product DROP CONSTRAINT FK_1493D942F6154FFA');
        ...
        $this->addSql('DROP TABLE symfony_demo_product_image');
